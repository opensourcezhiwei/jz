...
public class JinTianPay implements StatusCode {

	private final static Logger logger = LoggerFactory.getLogger(JinTianPay.class);
	...
	public static Map<String, Object> pay(BigDecimal amount, String orderNum, String type, PayConfigDetail detail, String ip) {
		...
		logger.info("jintian result = {}", result);
