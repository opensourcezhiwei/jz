...
public class YouQianPay implements StatusCode {

	private static final Logger logger = LoggerFactory.getLogger(YouQianPay.class);
...
//		String result = EdPay.postHtmlFrom(detail.getUrl(), paramMap, "post");
		...
		logger.info("YouQianPay result = {}", result);
